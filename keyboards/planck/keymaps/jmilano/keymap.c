...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_4, KC_5,    KC_6,   KC_RBRC, KC_BSLS,
    _______, _______, _______, _______, _______, _______, _______, KC_1, KC_2,    KC_3,   KC_PGDN, _______,
    _______, _______, _______, _______, _______, _______, _______, KC_0, _______, KC_DOT, KC_VOLU, KC_MPLY
),
